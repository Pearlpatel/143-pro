...
function gotposes(results) {
  if (results.length>0) {
    console.log(results);
    x_wrist=results[0].pose.nose.x;
    y_wrist=results[0].pose.nose.y;
...
function preload() {
	missed_wave=loadSound("missed.wav");
